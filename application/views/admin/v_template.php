    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">SDN DEMANGAN - YOGYAKARTA</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="<?php echo base_url().'dashboard/semuacontent' ?>">Semua Content</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url().'dashboard/kelas' ?>">Direktori Kelas</a>
                                </li>
                                <li>
                         ...
                         <li>
                            <a href="#"><i class="glyphicon glyphicon-certificate"></i> PRESTASI<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url().'dashboard/prestasipost' ?>">Prestasi Post</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url().'dashboard/semuaprestasi' ?>">Semua Prestasi</a>
                                </li>
                                
                                <li>
                                    <a href="<?php echo base_url().'dashboard/prestasi/sekolah' ?>">Prestasi Sekolah</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url().'dashboard/prestasi/guru' ?>">Prestasi Guru</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url().'dashboard/prestasi/siswa' ?>">Prestasi Siswa</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
